from utils.helpers import create_owner, create_statement_information
...
class CreateStatementInfoMixin:

    def add_statement_information(self, request, serializer_class):
        editable_request = request.data.copy()
        editable_request.__setitem__('information', create_statement_information().pk)
