    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('approved_by', models.ManyToManyField(to='padres.Person')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owners', models.ManyToManyField(to='transactions.Owner')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='company',
            name='owners',
            field=models.ManyToManyField(to='transactions.Owner'),
        ),
        migrations.AddField(
            model_name='company',
            name='possessions',
            field=models.OneToOneField(on_delete='PROTECT', related_name='companies', to='transactions.Owner'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='bankaccount',
            name='transactions',
            field=models.ManyToManyField(to='transactions.BankAccount'),
        ),
    ]
